...
type StreamChannelPresenceRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *StreamChannelPresenceRequest) Reset() {
	*x = StreamChannelPresenceRequest{}
	mi := &file_presence_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *StreamChannelPresenceRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StreamChannelPresenceRequest) ProtoMessage() {}

func (x *StreamChannelPresenceRequest) ProtoReflect() protoreflect.Message {
	mi := &file_presence_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StreamChannelPresenceRequest.ProtoReflect.Descriptor instead.
func (*StreamChannelPresenceRequest) Descriptor() ([]byte, []int) {
	return file_presence_proto_rawDescGZIP(), []int{1}
}

func (x *StreamChannelPresenceRequest) GetUserIds() []string {
	if x != nil {
		return x.UserIds
	}
	return nil
...
func (x *PresenceStatus) GetOnline() bool {
	if x != nil {
		return x.Online
	}
	return false
...
const file_presence_proto_rawDesc = "" +
	...
	"\x1cStreamChannelPresenceRequest\x12\x19\n" +
	"\buser_ids\x18\x01 \x03(\tR\auserIds\"A\n" +
	"\x0ePresenceStatus\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x16\n" +
	"\x06online\x18\x02 \x01(\bR\x06online2\xd2\x01\n" +
	"\bPresence\x12W\n" +
	"\vGetPresence\x12%.relay.presence.v1.GetPresenceRequest\x1a!.relay.presence.v1.PresenceStatus\x12m\n" +
	"\x15StreamChannelPresence\x12/.relay.presence.v1.StreamChannelPresenceRequest\x1a!.relay.presence.v1.PresenceStatus0\x01BKZIgithub.com/drim-dev/verifying-agent-code/go/src/relay/presence/presencepbb\x06proto3"
...
var file_presence_proto_goTypes = []any{
	(*GetPresenceRequest)(nil),           // 0: relay.presence.v1.GetPresenceRequest
	(*StreamChannelPresenceRequest)(nil), // 1: relay.presence.v1.StreamChannelPresenceRequest
	(*PresenceStatus)(nil),               // 2: relay.presence.v1.PresenceStatus
}
var file_presence_proto_depIdxs = []int32{
	0, // 0: relay.presence.v1.Presence.GetPresence:input_type -> relay.presence.v1.GetPresenceRequest
	1, // 1: relay.presence.v1.Presence.StreamChannelPresence:input_type -> relay.presence.v1.StreamChannelPresenceRequest
	2, // 2: relay.presence.v1.Presence.GetPresence:output_type -> relay.presence.v1.PresenceStatus
	2, // 3: relay.presence.v1.Presence.StreamChannelPresence:output_type -> relay.presence.v1.PresenceStatus
